...
public class CommandNode extends Node {
   ...
   * @throws InvalidCommandException       if the Command class corresponding to token is not found
  ...
  @Override
  public double evaluate() throws InvalidCommandException, InsufficientArgumentsException, InvalidOperandException {
    try {
 ...
 * This method dynamically loads the Command class using reflection based on the token,
 * and then attempts to retrieve the NUM_ARGS field.
 *
