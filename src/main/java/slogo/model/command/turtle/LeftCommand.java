...
/**
 * The LeftCommand class represents the command to rotate the turtle to the left by a specified number of degrees.
 * It sets the turtle's heading to the left of its current heading by the specified angle.
 *
 * @author Noah Loewy
 */
