...
/**
 * The SetHeadingCommand class represents the command to set the turtle's heading to a specified angle.
 * It sets the turtle's heading to the given angle and calculates the minimum angle of rotation to reach the new heading.
 *
 * @author Noah Loewy
 */
public class SetHeadingCommand implements Command {
   ...
   *
   * @param arguments a list of nodes representing the arguments for this command (containing one node with the angle to set)
