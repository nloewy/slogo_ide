...
/**
 * The BackwardCommand class represents a command that moves the turtle backward by a specified number of pixels.
 * It calculates the new position of the turtle based on its current heading and updates the turtle's state accordingly.
 *
 * @author Noah Loewy
 */
public class BackwardCommand implements Command {
   ...
   *
   * @param arguments a list of nodes representing arguments. The one node is the distance moved backwards.
