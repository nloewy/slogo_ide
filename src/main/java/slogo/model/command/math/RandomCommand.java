...
/**
 * The RandomCommand class represents the random mathematical operation.
 * It generates a random number between 0 (inclusive) and a specified maximum value (exclusive).
 *
 * @author Noah Loewy
 */
public class RandomCommand implements Command {
  ...
  /**
   * Constructs an instance of RandomCommand with the given model state and listener. This constructor
