...
/**
 * The QuotientCommand class represents the quotient mathematical operation.
 * It calculates the quotient of two given numbers.
 *
 * @author Noah Loewy
 */
public class QuotientCommand implements Command {
  ...
  /**
   * Constructs an instance of QuotientCommand with the given model state and listener. This constructor
