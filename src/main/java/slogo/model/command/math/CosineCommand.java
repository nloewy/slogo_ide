...
/**
 * The CosineCommand class represents the cosine mathematical operation.
 * It calculates the cosine of a given angle in degrees.
 *
 * @author Noah Loewy
 */
public class CosineCommand implements Command {
  ...
  /**
   * Constructs an instance of CosineCommand with the given model state and listener. This constructor
