...
/**
 * The GreaterThanCommand class represents the greater than comparison operation.
...
public class GreaterThanCommand implements Command {
   ...
   * @return 1.0 if the first node's value is greater than the second node's value,
   *         otherwise returns 0.0
