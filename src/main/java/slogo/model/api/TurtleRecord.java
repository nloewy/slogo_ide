 ...
 *
 * @Deprecated public TurtleRecord(int id, double x, double y, boolean pen, boolean visible, double
 * heading) { this(id, x, y, pen, visible, heading, 0, 0); // Default values for bgIndex and
 * penColorIndex }
 */