 ...
 * a command is expected and the token entered to the parser does not conform to the syntax or
 * format of a valid command, or if the properly formatted command is not recognized as a valid
 * Slogo or user-defined command.
 *
 * @author Noah Loewy
 */
