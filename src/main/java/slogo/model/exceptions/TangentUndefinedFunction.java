...
/**
 * The TangentUndefinedFunction class represents an exception that is thrown when attempting to take
 * the tangent root of a number that is an "odd" multiple of 90 degrees. This occurs during
