...
public class AnimationUtil {
    public static Animation makeAnimation(Node agent, Double newPosition, Double newPosition2, double heading) {
        // create something to follow
        Path path = new Path();
        path.getElements().addAll(
            new MoveTo(agent.getLayoutX(), agent.getLayoutY()),
            new LineTo(newPosition, newPosition2));
